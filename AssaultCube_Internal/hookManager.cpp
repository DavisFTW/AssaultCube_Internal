...
void hookManager::initHooks(EAThook& eatInstance)
{
	...
	funcO::o_doDamage = reinterpret_cast<funcT::t_doDamage>(detour::trampHook32((BYTE*)0x429C20, (BYTE*)hk_doDamageWrapperAddr, 6));  //#FIXME: store the doDamage original address another way :-)
	//doDamage_end
